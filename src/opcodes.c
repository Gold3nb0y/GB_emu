...
const instr instr_table[] = {
    ...
    [JR_NZ]         = {.opcode = JR_NZ,     .instr_fmt = "JRNZ %hhd",       .size = 2, .M_cycles = 12/8},
    ...
    [JR_Z]          = {.opcode = JR_Z,  .instr_fmt = "JRZ %hhd",       .size = 2, .M_cycles = 12/8},
    ...
    [JR_NC]         = {.opcode = JR_NC,     .instr_fmt = "JRNC %hhd",       .size = 2, .M_cycles = 12/8},
    ...
    [JR_C]          = {.opcode = JR_C,  .instr_fmt = "JRC %hhd",       .size = 2, .M_cycles = 12/8},
    ...
    [RET_NZ]        = {.opcode = RET_NZ,    .instr_fmt = "RET NZ",      .size = 1, .M_cycles = 20/8},
    [POP_BC]        = {.opcode = POP_BC,    .instr_fmt = "POP BC",      .size = 1, .M_cycles = 12},
    [JNZ]           = {.opcode = JNZ,   .instr_fmt = "JNZ 0x%04x",      .size = 3, .M_cycles = 16/12},
    [JMP]           = {.opcode = JMP,   .instr_fmt = "JMP 0x%04x",      .size = 3, .M_cycles = 16},
    [CALL_NZ]       = {.opcode = CALL_NZ,   .instr_fmt = "CALL NZ 0x%04x",         .size = 3, .M_cycles = 24/12},
    ...
    [RET_Z]         = {.opcode = RET_Z,     .instr_fmt = "RET Z",      .size = 1, .M_cycles = 20/8},
    [RET]           = {.opcode = RET,   .instr_fmt = "RET",      .size = 1, .M_cycles = 16},
    [JZ]            = {.opcode = JZ,    .instr_fmt = "JZ 0x%04x",       .size = 3, .M_cycles = 16/12},
    [CB_PREFIX]         = {.opcode = CB_PREFIX,     .instr_fmt = "PREFIX OP 0x%02x",       .size = 2, .M_cycles = 4},
    [CALL_Z]        = {.opcode = CALL_Z,    .instr_fmt = "CALL Z 0x%04x",         .size = 3, .M_cycles = 24/12},
    ...
    [RET_NC]        = {.opcode = RET_NC,    .instr_fmt = "RET NC",      .size = 1, .M_cycles = 20/8},
    [POP_DE]        = {.opcode = POP_DE,    .instr_fmt = "POP DE",      .size = 1, .M_cycles = 12},
    [JNC]           = {.opcode = JNC,   .instr_fmt = "JNC 0x%04x",      .size = 3, .M_cycles = 16/12},
    [CALL_NC]       = {.opcode = CALL_NC,   .instr_fmt = "CALL NC 0x%04x",         .size = 3, .M_cycles = 24/12},
    ...
    [RET_C]         = {.opcode = RET_C,     .instr_fmt = "RET C",      .size = 1, .M_cycles = 20/8},
    [RETI]          = {.opcode = RETI,  .instr_fmt = "RETI",         .size = 1, .M_cycles = 16},
    [JC]            = {.opcode = JC,    .instr_fmt = "JC 0x%04x",       .size = 3, .M_cycles = 16/12},
    [CALL_C]        = {.opcode = CALL_C,    .instr_fmt = "CALL C 0x%04x",         .size = 3, .M_cycles = 24/12},
